...
.. code-block:: python
    ...
    customer = Customer('Barack', 'Obama', 'barack@whitehouse.gov', '2024561111', '1600 Pennsylvania Avenue NW, Washington, DC, 20500')
    address = Address('1600 Pennsylvania Avenue NW', 'Washington', 'DC', '20500')
